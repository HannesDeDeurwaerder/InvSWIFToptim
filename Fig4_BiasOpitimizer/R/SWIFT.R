...
#' 
#' 
#' @param ARtot Description: The total absorptive root area of the focal plant
#'                           [in m2];  
#'              Structure:   One value, representative of the studied plant.#' 
#' @param Ax    Description: The total lumen area [in m2];  
#'              Structure:   One value, representative of the studied plant.
#' @param B     Description: The studied plant Root length density at every discrete soil layer 
